...
INSTRUCTION_PROMPT = {
    'mortality': '''\
Your primary task is to assess the provided ICU discharge summary to determine the likelihood of the patient not surviving their current hospital stay (in-hospital mortality).

Please first perform a step-by-step analysis of the patient data presented in the discharge summary. Then, provide a final assessment of the likelihood of in-hospital mortality.

Your final output must be a JSON object containing two keys:
1.  `"think"`: A string containing your detailed step-by-step clinical reasoning (under 500 words). Focus on the factors influencing the mortality risk based on the discharge note.
...
Example Format: ```json { "think": "The patient was admitted with severe sepsis, required prolonged ventilation. Although weaned off pressors, renal function remains poor and discharge from ICU is to the palliative care ward. Key risk factors include persistent organ dysfunction and goals of care discussion outcomes. Overall assessment suggests a very high risk of not surviving this hospitalization.", "answer": 0.90 }```''',
    ...
    'readmission': '''\
Your primary task is to assess the provided ICU discharge summary to predict the probability of unplanned hospital readmission OR death within 30 days following hospital discharge.

Please first perform a step-by-step analysis of the patient data presented in the discharge summary. Then, provide a final assessment of the predicted probability of 30-day readmission or mortality.

Your final output must be a JSON object containing two keys:
1.  `"think"`: A string containing your detailed step-by-step clinical reasoning (under 500 words). Focus on the factors influencing the 30-day post-discharge risk.
