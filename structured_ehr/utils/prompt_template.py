...
INSTRUCTING_MISSING_VALUE = ''' Values marked with `**` were initially missing and have been imputed using the Last Observation Carried Forward (LOCF) method. It is important that if a significant proportion of values for a specific feature are filled, the reliability of the analysis results for that feature should be considered relatively lower.

For example:
- Urea: "10**, 10**, 10**, 10**".
It indicates that all values are imputed, lowering the credibility of this feature.'''
